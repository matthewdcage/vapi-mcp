 ...
 */
export declare type AssistantOverridesClientMessagesItem = "conversation-update" | "function-call" | "function-call-result" | "hang" | "language-changed" | "metadata" | "model-output" | "speech-update" | "status-update" | "transcript" | "tool-calls" | "tool-calls-result" | "transfer-update" | "user-interrupted" | "voice-input";
