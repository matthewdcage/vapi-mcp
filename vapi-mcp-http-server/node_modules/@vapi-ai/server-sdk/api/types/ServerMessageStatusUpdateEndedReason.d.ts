...
export declare const ServerMessageStatusUpdateEndedReason: {
    ...
    readonly AssistantSaidMessageWithEndCallEnabled: "assistant-said-message-with-end-call-enabled";
    ...
    readonly DbError: "db-error";
    readonly AssistantNotFound: "assistant-not-found";
    readonly LicenseCheckFailed: "license-check-failed";
    ...
    readonly PipelineErrorNeetsVoiceFailed: "pipeline-error-neets-voice-failed";
    ...
    readonly PipelineNoAvailableModel: "pipeline-no-available-model";
    ...
    readonly VapifaultPhoneCallWorkerSetupSocketError: "vapifault-phone-call-worker-setup-socket-error";
    readonly VapifaultPhoneCallWorkerWorkerSetupSocketTimeout: "vapifault-phone-call-worker-worker-setup-socket-timeout";
    readonly VapifaultPhoneCallWorkerCouldNotFindCall: "vapifault-phone-call-worker-could-not-find-call";
    readonly VapifaultTransportNeverConnected: "vapifault-transport-never-connected";
    readonly VapifaultWebCallWorkerSetupFailed: "vapifault-web-call-worker-setup-failed";
    readonly VapifaultTransportConnectedButCallNotActive: "vapifault-transport-connected-but-call-not-active";
    readonly VapifaultCallStartedButConnectionToTransportMissing: "vapifault-call-started-but-connection-to-transport-missing";
    ...
    readonly SipGatewayFailedToConnectCall: "sip-gateway-failed-to-connect-call";
